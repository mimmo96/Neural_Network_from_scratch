...
learning_rate = [0.01, 0.04, 0.065, 0.2, 0.5, 1, 3, 4]
alfa = [0.5, 0.65, 0.9]
v_lambda = [0, 0.001,0.0001]
fun=["sigmoidal", "tanh"]
...
nj=[[dim_input,2,dim_output,0], [dim_input,5,dim_output,0], [dim_input,2,3,dim_output,0], [dim_input,3,5,dim_output,0],[dim_input,3,6,dim_output,0] ]
